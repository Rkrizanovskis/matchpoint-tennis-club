// Simple Tennis Club App - Works with or without Firebase
console.log('Tennis app script loaded');
...
function editPlayer(playerId) {
    ...
    savePlayers();
    loadPlayers();
    renderSchedule(); // Refresh schedule to show updated names
}
...
console.log('Tennis app script loaded successfully');